<template>
    <el-dialog v-model="modelValue" title="计算字段" width="30%" :close-on-click-modal="false" :close-on-press-escape="false" :destroy-on-close="true">
        ...
        <el-form ref="addExpressionFormRef" :model="data" label-width="80px">
            ...
            <el-form-item label="相关实体" prop="entities">

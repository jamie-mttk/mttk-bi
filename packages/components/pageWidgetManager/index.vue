<template>
  <div>
    <el-alert title="Page widget is to convert a page into a widget with properties and event to customize."
...
function resetPageWidget() {
  globalContext.componentRepository.resetPageWidget(globalContext)
}

//
function handleAdd() {
  //
  wizardRef.value.show({ sys: { folder: 'pageWidget' }, data: [], ui: [], event: [] ,modelValue:{}}, callback)
}

<template>
  <div class="toolbar-table-container" style="margin: 0 6px 0 6px">
          ...
          <splitpanes horizontal class="default-theme"  >
            ...
            <pane style="background-color: #fff;" size="70">
              <el-tabs v-model="activeTab">
                <el-tab-pane :label="$t('bi.plugin.modelEditor.single.field')" name="field">
                  <FieldEditor v-model="model"></FieldEditor>
                </el-tab-pane>
                <el-tab-pane :label="$t('bi.plugin.modelEditor.single.preview')" name="preview">
...
import { vFullHeight,locale } from 'mttk-lowcode-engine'
...
function saveModel() {
  ...
  globalContext
    ...
    .then(function () {
      ...
      //
      ElMessage({
        message: locale.t('_._.saveSuccess'),
        type: 'success'
      })
    })
}
...
function handleReturn() {
  if (dirty) {
    ElMessageBox.confirm(locale.t('bi.plugin.modelEditor.single.saveConfirm'), locale.t('_._.confirm'), {

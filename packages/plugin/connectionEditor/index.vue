<template>
  <div class="toolbar-table-container" style="margin:0 24px 0 8px;">
    <div class="lc-common-toolbar toolbar" style="background-color: var(--el-color-primary)">
      <div class="left" style="font-weight: bold; color: var(--el-color-white);">{{ $t('bi.plugin.connectionEditor.name') }}</div>
    ...
    <el-table :data="tableData"  class="table-area" v-fullHeight="8">
      ...
      <el-table-column prop="driverClass" :label="$t('bi.plugin.connectionEditor.data.driverClass')" />
      <el-table-column prop="url" label="URL" />
      <el-table-column prop="readonly" :label="$t('bi.plugin.connectionEditor.data.readonly')" width="120px">
        <template #default="sp">
          <el-switch
      ...
      <el-table-column fixed="right" :label="$t('_._.operation')" width="260px">
        <template #default="sp">
          <el-button-group>

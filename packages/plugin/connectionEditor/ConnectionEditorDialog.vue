<template>
    <el-dialog v-model="dialogVisible" :title="$t('_._.edit')+' '+$t('bi.plugin.connectionEditor.name')" :close-on-click-modal="false" :close-on-press-escape="false">
        <el-form ref="connectionEditorFormRef" :model="formData"  label-width="120px">
            ...
            <el-form-item :label="$t('bi.plugin.connectionEditor.data.driverClass')"  prop="driverClass" required>
                <el-input v-model="formData.driverClass" />
            </el-form-item>
            <el-form-item label="URL"  prop="url" required>
                <el-input v-model="formData.url" />
            </el-form-item>
            <el-form-item :label="$t('bi.plugin.connectionEditor.data.user')"  prop="user" >

      ...
      //Title
      {
        ...
        _children: [
          ...
          },
          {
            ...
            type: 'textarea',
            rows: 4,
            '~show': computed(() => unref(data)['title-config'] == 'customize')
          },
          {
            '~component': 'el-input',
            '~label': 'Title text',
            '~prop': 'title-text',
            '~show': computed(() => unref(data)['title-config'] == 'ui')
          },
          {
            '~component': 'el-input',
            '~label': 'Title subtext',
      ...
      //Legend
      {
        ...
        _children: [
          ...
          },
          {
            ...
            type: 'textarea',
            rows: 4,
            '~show': computed(() => unref(data)['legend-config'] == 'customize')
          },
          {
            '~component': 'el-select',
            '~label': 'Legend icon',
            ...
            '~show': computed(() => unref(data)['legend-config'] == 'ui')
          },
          {
            '~component': 'el-input',
      ...
      //Grid
      {
        ...
        _children: [
          ...
          },
          {
            ...
            type: 'textarea',
            rows: 4,
            '~show': computed(() => unref(data)['grid-config'] == 'customize')
          },
          {
            '~component': 'el-switch',
            '~label': 'Grid show',
            '~prop': 'grid-show',
            '~show': computed(() => unref(data)['grid-config'] == 'ui')
          },
          {
            '~component': 'el-input',
            '~label': 'Grid left',
      ...
      //Tooltip
      {
        ...
        _children: [
          ...
          },
          {
            ...
            type: 'textarea',
            rows: 4,
            '~show': computed(() => unref(data)['tooltip-config'] == 'customize')
          },
          {
            '~component': 'el-select',
            ...
            '~show': computed(() => unref(data)['tooltip-config'] == 'ui')
          },
          {
            '~component': 'el-input',
      ...
      //XAxis
      {
        ...
        _children: [
          ...
          },
          {
            ...
            type: 'textarea',
            rows: 4,
            '~show': computed(() => unref(data)['xAxis-config'] == 'customize')
          },
          {
            '~component': 'el-select',
            '~label': 'XAxis type',
            ...
            '~show': computed(() => unref(data)['xAxis-config'] == 'ui')
          },
          {
            '~component': 'el-input',
            '~label': 'XAxis name',
      ...
      //YAxis
      {
        ...
        _children: [
          ...
          },
          {
            ...
            type: 'textarea',
            rows: 4,
            '~show': computed(() => unref(data)['yAxis-config'] == 'customize')
          },
          {
            '~component': 'el-select',
            '~label': 'YAxis type',
            ...
            clearable: true,
            '~options': ['category', 'value', 'time', 'log'],
            '~show': computed(() => unref(data)['yAxis-config'] == 'ui')
          },
          {
            '~component': 'el-input',
            '~label': 'YAxis name',

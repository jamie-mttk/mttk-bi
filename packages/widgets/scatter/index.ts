      ...
      ui: [
        ...
        widgetUtil.createSelect(
          ...
          [
            ...
            { label: locale.t('bi.widgets.scatter.regression-curve_exponential'), value: 'exponential' },
            { label:locale.t('bi.widgets.scatter.regression-curve_logarithmic'), value: 'logarithmic' },
            { label: locale.t('bi.widgets.scatter.regression-curve_polynomial'), value: 'polynomial' }
          ],
        ...
        widgetUtil.createSwitch('show-range-area', locale.t('bi.widgets.scatter.show-range-area')),
        widgetUtil.createSwitch('show-average-line',locale.t('bi.widgets.scatter.show-average-line')),
        widgetUtil.createSwitch('highlight-min-max', locale.t('bi.widgets.scatter.highlight-min-max'))
      ]
    },
    ...buildOtherProp()
  }

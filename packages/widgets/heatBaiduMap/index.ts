...
const biHeatBaiduMapConfig = {
  ...
  editor: {
    model: buildModelFull({
        ...
        { _type: 'dimension', description:locale.t('bi.widgets.heatBaiduMap.dimension_description'), option: { maxRow: 3,minRow:2 } },
        { _type: 'metric', description:locale.t('bi.widgets.heatBaiduMap.metric_description'), option: { maxRow: 1,minRow:0 } },
        ...commonMoldelConfig
      ]),
    basic: {
      ...
      ui: [
        ...buildEchartsBaseUI(),
        widgetUtil.createInput('baidu-map-ak',locale.t('bi.widgets.heatBaiduMap.baidu-map-ak')),
        widgetUtil.createInputNumber('center-longitude',locale.t('bi.widgets.heatBaiduMap.center-longitude')),
        widgetUtil.createInputNumber('center-latitude',locale.t('bi.widgets.heatBaiduMap.center-latitude')),
        widgetUtil.createInputNumber('zoom',locale.t('bi.widgets.heatBaiduMap.zoom')),
        widgetUtil.createInputNumber('point-size',locale.t('bi.widgets.heatBaiduMap.point-size')),

...
//
export const baseConfigList={excludeList:['xAxis','yAxis','dataZoom']}
//
const biPieConfig = {
  key: '_bi_pie',
      ...
      ui: [
        {
          ...
          '~label': locale.t('bi.widgets.pie.name'),
          '~default':true,
          _children: [
            ...
            widgetUtil.createInput('border-radius', locale.t('bi.widgets.pie.border-radius')),
